  ...
  return (
    <div className="space-y-6">
      ...
      {seedError && (
        <div
          role="alert"
          className="flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3 print:hidden"
        >
      ...
      {banner && !seedError && (
        <div
          role="status"
          aria-live="polite"
          className="rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800 print:hidden"
        >
          {banner}
        </div>
      )}
